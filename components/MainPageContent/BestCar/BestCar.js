...
import classes from "./BestCar.css";
  ...
  <Grid container spacing={0}>
    <Grid item xs={7} style={{ padding: "0 15px" }}>
      <div className={classes.BestCarComposition}>
        ...
        <img
          src="https://firebasestorage.googleapis.com/v0/b/react-burger-99366.appspot.com/o/assets%2Fcar-633x238.png?alt=media&token=ec0bd773-de0e-4acf-bfd0-fb53d513c2df"
          alt="car"
        />
      </div>
    </Grid>
