    ...
    return (
      <MuiThemeProvider theme={theme}>
        ...
        <Card className={classes.PostCard}>
          <CardMedia
            className={classes.PostCardImage}
            image="https://firebasestorage.googleapis.com/v0/b/react-burger-99366.appspot.com/o/news%2Fautoroku_news_image_1.jpg?alt=media&token=f3cedd37-edcd-4e37-a527-a4420e42eeec"
            title="news"
          />
          <CardContent>
            <Dotdotdot clamp={2}>
        ...
        <Card className={classes.PostCard}>
          <CardMedia
            className={classes.PostCardImage}
            image="https://firebasestorage.googleapis.com/v0/b/react-burger-99366.appspot.com/o/news%2Fautoroku_news_image_2.jpg?alt=media&token=d20c2f97-3713-4a0b-8429-f9b918184b8c"
            title="news"
          />
          <CardContent>
            <Dotdotdot clamp={2}>
        ...
        <Card className={classes.PostCard}>
          <CardMedia
            className={classes.PostCardImage}
            image="https://firebasestorage.googleapis.com/v0/b/react-burger-99366.appspot.com/o/news%2Fautoroku_news_image_3.jpg?alt=media&token=ec6aafee-26ea-4e55-9065-91c0044b0573"
            title="news"
          />
          <CardContent>
            <Dotdotdot clamp={2}>
